...
const Y_DEFAULTS: Record<string, number> = {
  ...
  mounted_fish: 2.0,
  winner_trophy_gold: 2.8,
  winner_trophy_silver: 2.8,
  winner_trophy_bronze: 2.8,
...
> = {
  ...
  /** Podietrofæer: små forskydninger, så de ikke overlapper over kamin. */
  winner_trophy_gold: { x: -3.6, z: -4.8, rot: 0 },
  winner_trophy_silver: { x: -3.45, z: -4.78, rot: 0 },
  winner_trophy_bronze: { x: -3.75, z: -4.82, rot: 0 },
