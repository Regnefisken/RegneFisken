...
/** Fast XP og mål-toast i mobil-mode (legacy top-fixed). Streak ved bund-Sælg alt (HUD). Kiste via 🎒 Fisketaske. */
  ...
  return (
    <>
      ...
      >
        {xpToast && (
          <div
            className="xp-toast-hud pointer-events-none mb-2 rounded-xl font-black whitespace-nowrap text-emerald-300"
            style={{
