  ...
  return (
    <div className="flex flex-col gap-2 py-1 text-xs">
      ...
      <div className="flex items-start gap-1">
        ...
        <LockToggle paramKey="bodyShape.1" />
      </div>
      <div className="flex items-start gap-1">
        <div className="flex-1">
          <SliderRow
        ...
        <LockToggle paramKey="bodyShape.2" />
      </div>
      <div className="flex items-start gap-1">
        <div className="flex-1">
          <SliderRow
        ...
        <LockToggle paramKey="scale" />
      </div>

      <div className="flex items-start gap-1">
        <label className="flex flex-1 flex-col gap-0.5 text-gray-300" title="Haleform — extruderede former (slør, lyre, …) kræver standard fisk">
          <span>Haleform</span>
          <select
      ...
      <div className="flex items-start gap-1">
        <label className="flex flex-1 flex-col gap-0.5 text-gray-300" title="Grundform af kroppen (sphere + deformation, som i electric monster generator)">
        ...
        <LockToggle paramKey="bodyProfile" />
      </div>

      <details className="mt-1 rounded border border-gray-600/50">
        <summary className="cursor-pointer px-1 py-0.5 text-[11px] text-gray-400">▸ Avanceret krop</summary>
        <div className="flex flex-col gap-2 p-1">
          ...
          <div className="flex items-start gap-1">
            <label
              className="flex flex-1 flex-col gap-0.5 text-gray-300"
            ...
            <LockToggle paramKey="bodyShadingStyle" />
          </div>
          <div className="flex items-start gap-1">
            <div className="flex-1">
              <SliderRow
            ...
            <LockToggle paramKey="bodyClearcoat" />
          </div>
          <div className="flex items-start gap-1">
            <div className="flex-1">
              <SliderRow
            ...
            <LockToggle paramKey="bodyClearcoatRoughness" />
          </div>
          ...
          {import.meta.env.DEV && (
            <>
              <div className="flex items-start gap-1">
                ...
                <LockToggle paramKey="bodySegments" />
              </div>
