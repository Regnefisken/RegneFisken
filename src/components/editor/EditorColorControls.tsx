    ...
    <div className="flex flex-col gap-2 py-1 text-xs">
      ...
      <details className="mt-1 rounded border border-gray-600/50">
        ...
        <div className="flex flex-col gap-2 p-1">
          <div className="flex items-start gap-1">
            <label
              className="flex flex-1 flex-col gap-0.5 text-gray-400"
            ...
            <LockToggle paramKey="colorGradient" />
          </div>
          ...
          <div className="flex items-start gap-1">
            <label className="flex flex-1 items-center gap-2 text-gray-400" title="Overskriver 4-zone gradient med spektral-regnbue">
              <input
                type="checkbox"
                checked={rainbowOn}
            ...
            <LockToggle paramKey="useRainbow" />
          </div>
          <div className="flex items-start gap-1">
            <label className="flex flex-1 items-center gap-2 text-gray-400" title="Langsom HSL-animation på kropsfarve">
              <input
                type="checkbox"
            ...
            <LockToggle paramKey="chameleonMode" />
          </div>

          <div className="mt-1 flex flex-col gap-2 border-t border-gray-600/80 pt-2">
            <div className="flex items-start gap-1">
              <label
                className="flex flex-1 items-center gap-2 text-gray-400"
              ...
              <LockToggle paramKey="bodyHemisphereTint" />
            </div>
            {hemiOn && hemi && (
              <div className="flex flex-col gap-2 pl-1">
      ...
      <details className="mt-1 rounded border border-gray-600/50">
        <summary className="cursor-pointer px-1 py-0.5 text-[11px] text-gray-400">▸ Gennemsigtighed</summary>
        <div className="flex flex-col gap-2 p-1">
          <div className="flex items-start gap-1">
            <label className="flex min-w-0 flex-1 flex-col gap-0.5 text-gray-400">
            ...
            <LockToggle paramKey="bodyOpacity" />
          </div>
          <div className="flex items-start gap-1">
            <label className="flex min-w-0 flex-1 flex-col gap-0.5 text-gray-400">
            ...
            <LockToggle paramKey="finOpacity" />
          </div>
        </div>
      </details>

      <details className="mt-1 rounded border border-gray-600/50">
        <summary className="cursor-pointer px-1 py-0.5 text-[11px] text-gray-400">▸ Emissive (glød)</summary>
