...
export const LOCATIONS = {
  ...
  cabin_living: {
    ...
    emoji: '🏠',
    unlockLevel: 1,
    requiresItem: 'cabin_key',
    type: 'base',
    description: 'Dit hjem — slap af med dine kæledyr',
    bgColor: 0x87ceeb,
    waterColor: 0x5F9EA0,
    fogColor: 0x87ceeb,
    fogNear: 22,
  ...
  cabin_kitchen: {
    ...
    requiresItem: 'cabin_key',
    type: 'base',
    description: 'Et rustikt køkken med udsigt',
    bgColor: 0x87ceeb,
    waterColor: 0x5F9EA0,
    fogColor: 0x87ceeb,
    fogNear: 22,
  ...
  cabin_bedroom: {
    id: 'cabin_bedroom',
    name: 'Fiskehytten',
    subtitle: 'Soveværelse',
    parentGroup: 'fishing_cabin',
    emoji: '🏠',
    unlockLevel: 1,
    requiresItem: 'cabin_key',
    type: 'base',
    description: 'Et stille soveværelse',
    bgColor: 0x87ceeb,
    waterColor: 0x5F9EA0,
    fogColor: 0x87ceeb,
    fogNear: 22,
